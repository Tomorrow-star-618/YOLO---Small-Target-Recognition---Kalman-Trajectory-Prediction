...
def aircraft_detection_tracking():
    """红外小目标飞机检测与跟踪系统主程序."""
    # 输入视频路径
    video_path = "/home/mingxing/worksapce/ultralytics/video/short.mp4"
    ...
    try:
        while True:
            ...
            cv2.putText(vis_frame, title, (10, title_y), cv2.FONT_HERSHEY_SIMPLEX, 1.0, title_color, 3)
